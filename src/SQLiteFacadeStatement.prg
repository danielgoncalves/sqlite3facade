 ...
 *
 *  <p>This façade makes the use of host parameters and parameter value
...
METHOD executeQuery()
   ...
   ELSE
      ...
      IF ( HB_ASCAN( { SQLITE_DONE, SQLITE_ERROR }, ::lastExecuteResult ) > 0 )
      ...
      IF ( HB_ASCAN( { SQLITE_OK, SQLITE_DONE }, ::lastExecuteResult ) > 0 )
         // no data!
